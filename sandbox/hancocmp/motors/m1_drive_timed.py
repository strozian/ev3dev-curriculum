...
#     300 degrees / second  -->  traveled 35.2 inches  -->  3.52 inches / second
...
#     700 degrees / second  -->  traveled 40.1 inches  -->  8.02 inches / second
...
def main():
    ...
    while True:
        ...
        motor_sp = int(input("Enter a speed for both motors (0 to 900 dps): "))
        if motor_sp == 0:
            break
